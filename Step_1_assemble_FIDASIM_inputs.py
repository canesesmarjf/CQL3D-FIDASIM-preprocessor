...
def main():
    ...
    # Metadata for run:
    user_input["runid"] = "WHAM_example"
    user_input["comment"] = "FIDASIM NBI thermal deposition in WHAM with halo physics enabled. Removed the denf + deni(i) step in get_rate_matrix. Added the 2/3 term to the temperature"
    ...
    user_input["dene_LCFS"] = 1e8
    user_input["te_LCFS"] = 0.001
    user_input["ti_LCFS"] = 0.001
    ...
    user_input['n_nbi'] = 1e5
    user_input['n_birth'] = 1e5
    user_input['n_dcx'] = 1e5
    user_input['n_halo'] = 1e5
