...
# Executable:
EXECUTABLE=./xcql3d_mpi.perl.debug

# Run CQL3DM:
# ===========================================================
cd $CQL3D_RUN_DIR
#time ddt --srun mpirun -n $NUM_PROCS $CQL3DM_DIR/xcql3dm_mpi.gfortran64_DEBUG > log.txt
ddt --connect srun -n $NUM_PROCS $CQL3DM_DIR/$EXECUTABLE
cd $START_DIR
